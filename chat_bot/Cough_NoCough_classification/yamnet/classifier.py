...
import Cough_NoCough_classification.yamnet.yamnet as yamnet_model
from Cough_NoCough_classification.yamnet import params

YAMNET_DIR = os.path.join("Cough_NoCough_classification", "yamnet")
