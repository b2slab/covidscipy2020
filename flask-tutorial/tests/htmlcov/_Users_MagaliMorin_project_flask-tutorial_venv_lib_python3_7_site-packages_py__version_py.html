...
<head>
    ...
    <title>Coverage for /Users/MagaliMorin/project/flask-tutorial/venv/lib/python3.7/site-packages/py/_version.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/Users/MagaliMorin/project/flask-tutorial/venv/lib/python3.7/site-packages/py/_version.py</b> :
...
<div id="source">
    ...
    <p id="t4" class="run"><span class="n"><a href="#t4">4</a></span><span class="t"><span class="nam">version</span> <span class="op">=</span> <span class="str">'1.8.1'</span>&nbsp;</span><span class="r"></span></p>
</div>
<div id="footer">
    <div class="content">
        <p>
